...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_folder", type=str, default="/home/robot-learning/Projects/ws_Haonan/BundleTrack/data/")
    parser.add_argument("--data_name", type=str, default="test_data")
